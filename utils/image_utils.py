...
def generate_enhanced_image(image: Image.Image, style: str):
    ...
    try:
        ...
        prompt = style_prompts.get(style, "A high-quality, professional product photograph of the subject.")
        ...
        if "permission" in str(e).lower():
            st.warning("Please ensure the Gemini API is enabled and your project has access to the 'gemini-2.5-flash-image-preview' model in your Google Cloud Console.")
        return None